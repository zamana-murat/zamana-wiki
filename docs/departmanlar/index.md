...
-   :material-handshake:{ .lg .middle } **Satış ve İş Geliştirme**

    ---

    Teklif, müşteri iletişimi, pipeline analizi, tender yanıtları, anlaşma teşhisi.

    [:octicons-arrow-right-24: Satış](satis.md)

-   :material-bullhorn-outline:{ .lg .middle } **Pazarlama ve İletişim**

    ---

    İçerik üretimi, kampanya planlama, kriz iletişimi, influencer brief'leri.

    [:octicons-arrow-right-24: Pazarlama](pazarlama.md)

-   :material-calculator-variant-outline:{ .lg .middle } **Finans ve Muhasebe**

    ---

    Rapor anlatısı, bütçe varyansı, KOSGEB/TÜBİTAK başvuruları, denetim dosyası.

    [:octicons-arrow-right-24: Finans](finans.md)

-   :material-factory:{ .lg .middle } **Operasyon ve Lojistik**

    ---

    SOP dokümantasyonu, tedarikçi yönetimi, incident raporu, NCR.

    [:octicons-arrow-right-24: Operasyon](operasyon.md)

-   :material-account-group-outline:{ .lg .middle } **İnsan Kaynakları**

    ---

    İş ilanı, performans değerlendirme, politika yazımı, onboarding.

    [:octicons-arrow-right-24: İnsan Kaynakları](insan-kaynaklari.md)

-   :material-scale-balance:{ .lg .middle } **Hukuk ve Uyum**

    ---

    Sözleşme taslağı, madde çıkarımı, KVKK veri sahibi talepleri, iç memolar.

    [:octicons-arrow-right-24: Hukuk](hukuk.md)

-   :material-laptop:{ .lg .middle } **Bilgi Teknolojileri**

    ---

    Teknik dokümantasyon, incident rapor, PowerShell script'leri, KVKK teknik uyum.

    [:octicons-arrow-right-24: Bilgi Teknolojileri](bilgi-teknolojileri.md)

-   :material-headset:{ .lg .middle } **Müşteri Hizmetleri**

    ---

    Şikayet yanıtları, sosyal medya krizi, VIP iletişimi, FAQ.

    [:octicons-arrow-right-24: Müşteri Hizmetleri](musteri-hizmetleri.md)

-   :material-briefcase-outline:{ .lg .middle } **İdari İşler**

    ---

    Yazışma, toplantı tutanağı, yönetici brifingi, yönetim kurulu paketi.

    [:octicons-arrow-right-24: İdari İşler](idari-isler.md)

-   :material-crown-outline:{ .lg .middle } **Liderlik ve Yönetim**

    ---

    Stratejik düşünme ortağı, bilgi sentezi, yönetim kurulu iletişimi, M&A.

    [:octicons-arrow-right-24: Liderlik](liderlik.md)

-   :material-cart-outline:{ .lg .middle } **Satınalma**

    ---

    RFP, tedarikçi değerlendirme, pazarlık hazırlığı, TCO analizi.

    [:octicons-arrow-right-24: Satınalma](satinalma.md)

-   :material-earth:{ .lg .middle } **İhracat ve Uluslararası Ticaret**

    ---

    LOI, FCO, SPA, CIS, pazar istihbaratı, LC uyuşmazlıkları — Zamana'nın net farklılaştırıcısı.

    [:octicons-arrow-right-24: İhracat](ihracat.md)
...
- [**CLAUDE.md Örnekleri**](../claude-md/ornekler.md) — Rolünüze uygun hazır CLAUDE.md
- [**Prompting**](../prompting/index.md) — Kaliteli prompt yazma
- [**Yetenekler**](../yetenekler/index.md) — Skills, Artifacts, Computer Use
- [**MCP Bağlantı Listesi**](../mcp/baglanti-listesi.md) — Rolünüze göre connector'lar
