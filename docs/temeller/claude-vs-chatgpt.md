...
# Claude vs ChatGPT — Dürüst Bir Karşılaştırma
...
- [Claude Modelleri](modeller.md) — Haiku / Sonnet / Opus
- [Claude Planları](planlar.md) — Fiyat ve özellik detayları
- [Cowork Modu](../araclar/cowork-modu.md) — Claude'un kurumsal çalışma ortamı
- [CLAUDE.md Nedir?](../claude-md/nedir.md) — Şeffaf kalıcı hafıza
