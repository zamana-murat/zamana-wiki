...
-   :material-school:{ .lg .middle } **Claude'a yeni misiniz?**

    ---

    Temel kavramlar, Claude'un ne olduğu, ne olmadığı ve neden ChatGPT'den farklı düşündüğü.

    [:octicons-arrow-right-24: Temeller](temeller/index.md)

-   :material-tools:{ .lg .middle } **Hangi araçla başlamalıyım?**

    ---

    Claude Desktop, Cowork modu ve Claude.ai — hangisi hangi iş için doğru seçim.

    [:octicons-arrow-right-24: Araçlar](araclar/index.md)

-   :material-file-document:{ .lg .middle } **CLAUDE.md nedir?**
